        ...
        <div className="pt-24 pb-20">
            <div className="container mx-auto px-4 md:px-8">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Selected <span className="text-[#8b1a85]">Projects</span></h1>
                ...
                <div className="flex overflow-x-auto gap-8 pb-8 snap-x scrollbar-hide">
                    {projectsList.map((project, index) => (
                        <motion.div
                            ...
                            className="group relative overflow-hidden rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-300 min-w-[320px] md:min-w-[400px] snap-center bg-[#141414]"
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <span className="text-[#8b1a85] text-sm font-semibold uppercase">{project.type}</span>
